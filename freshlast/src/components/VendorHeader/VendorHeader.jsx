    ...
    <header className="vendor-header">
      <div className="vendor-header__inner">
        ...
        <nav className="vendor-header__nav">
          <a href="#" className="vendor-header__nav-link vendor-header__nav-link--active">
            Vendor Dashboard
          </a>
        </nav>

        <div className="vendor-header__actions">
          <button className="vendor-header__icon-btn" title="Marketplace" onClick={() => navigate('/')}>
            <HomeIcon />
          </button>
          ...
          <button className="vendor-header__icon-btn" title="Admin Dashboard" onClick={() => navigate('/admin')}>
            <SettingsIcon />
          </button>
